...
class Model:
    ...
    def ctranslate2_translate_lines(self, lines: List[str], beam_len:int) -> List[str]:
    ...
    def fairseq_translate_lines(self, lines: List[str], beam_len:int) -> List[str]:
        self.translator.cfg.generation.beam = beam_len
    ...
    def batch_translate(self, batch: List[str], src_lang: str, tgt_lang: str, beam_len:int) -> List[str]:
        """
